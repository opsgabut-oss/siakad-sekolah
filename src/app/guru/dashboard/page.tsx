  ...
  return (
    <div className="space-y-6 flex-1 flex flex-col justify-center">
      ...
      <div className="space-y-1 text-center md:text-left">
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold text-white tracking-tight">Presensi Kelas</h1>
        <p className="text-slate-400 text-xs md:text-sm">
          Pilih kelas dan tanggal presensi hari ini untuk mencatat kehadiran siswa secara digital.
        </p>
      </div>
